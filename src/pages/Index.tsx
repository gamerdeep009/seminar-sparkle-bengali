        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start space-x-3 mb-4">
                <img src={cyberSecurityLogo} alt="HIT Logo" className="h-10 w-10" />
                <div>
                  <h3 className="font-bold text-foreground">
                    {language === 'en' ? 'Haldia Institute of Technology' : 'হলদিয়া ইনস্টিটিউট অফ টেকনোলজি'}
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    {language === 'en' ? 'Excellence in Technical Education' : 'প্রযুক্তিগত শিক্ষায় উৎকর্ষতা'}
                  </p>
                </div>
              </div>
            ...
            <div className="text-center md:text-left">
              ...
              <div className="space-y-2">
                <a href="#about" className="block text-sm text-muted-foreground hover:text-primary transition-colors">
                  {language === 'en' ? 'About Seminar' : 'সেমিনার সম্পর্কে'}
                </a>
            ...
            <div className="text-center md:text-left">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <p>📧 cybersecurity.seminar@hithaldia.ac.in</p>
                <p>📞 +91 3224 252025</p>
          ...
          <div className="border-t border-border/50 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-sm text-muted-foreground">
                © 2025 {language === 'en' ? 'Haldia Institute of Technology' : 'হলদিয়া ইনস্টিটিউট অফ টেকনোলজি'}. {language === 'en' ? 'All rights reserved.' : 'সর্বস্বত্ব সংরক্ষিত।'}
              </p>
